...
<body class="font-sans text-slate-800 antialiased min-h-screen relative overflow-x-hidden selection:bg-primary selection:text-white">
    ...
    <div class="fixed inset-0 w-full h-full pointer-events-none z-[-1] overflow-hidden">
        ...
        <div class="absolute top-0 -right-4 w-96 h-96 bg-cyan-300 rounded-full mix-blend-multiply filter blur-[100px] opacity-70 animate-blob"
             style="animation-delay: 2s;">
        </div>

        <div class="absolute -bottom-8 left-20 w-96 h-96 bg-pink-300 rounded-full mix-blend-multiply filter blur-[100px] opacity-70 animate-blob"
    ...
    <nav class="fixed top-0 w-full z-50 glass-panel border-t-0 border-x-0 rounded-none bg-white/70 mb-8 animate-fade-in transition-all duration-300">
        ...
        <div class="container mx-auto px-6 max-w-7xl flex justify-between items-center py-4">
            ...
            <a href="{{ route('dashboard') }}"
               class="text-3xl font-extrabold flex items-center tracking-tight group">
                ...
                <span class="text-slate-800">
                    Nexus<span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">
                        Inventory
                    </span>
                </span>
            ...
            <!-- Navigation Links -->
            <div class="flex flex-wrap items-center justify-end gap-1 sm:gap-2 bg-white px-2 py-1.5 rounded-2xl border border-slate-200 shadow-sm">

                <a href="{{ route('dashboard') }}"
                   class="text-slate-600 hover:text-primary hover:bg-slate-50 px-4 py-2 rounded-full font-bold transition-all text-sm tracking-wide">
                    Dashboard
                </a>
