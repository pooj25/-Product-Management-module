...
<div class="max-w-4xl mx-auto opacity-0 animate-slide-up">
    <div class="flex justify-between items-center mb-10 pb-6 border-b border-slate-200">
        <h2 class="text-4xl font-extrabold text-slate-900 tracking-tight">Create <span class="text-gradient">Category</span></h2>
    ...
    <form action="{{ route('categories.store') }}" method="POST" class="glass-panel p-10 space-y-8 relative overflow-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
            <div class="col-span-1 md:col-span-2">
                ...
                <input type="text" name="name" id="name" class="input-premium focus:ring-accent/50 focus:border-accent" placeholder="e.g. Mobiles" value="{{ old('name') }}">
            </div>
